...
<head>
    ...
    <link rel="stylesheet"
          href="https://fonts.googleapis.com/css?family=Solway">
    <link rel="stylesheet"
...
<body>
    <header class="bloc-beige">
        <nav>

            <?php 

                if(isset($_SESSION['loggedUser'])) {
                    echo('<a class="text-marron lien" href="./../php/restaurants_enregistres.php">Restaurants Favoris</a>');
                    echo('<svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="60" cy="60" r="50" fill="#F3471E"/></svg>');
                    echo('<a class="text-marron lien" href="./../pages/deconnexion.html">Deconnexion</a>');
                }
                else {
                    echo('<a class="text-marron lien" href="./../pages/inscription.html">Inscription</a>');
                    echo('<svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="60" cy="60" r="50" fill="#F3471E"/></svg>');
                    echo('<a class="text-marron lien" href="./../pages/connexion.html">Connexion</a>');
                }
            ?>
        ...
        <div>
            <div id="titres">
                <h1 class="text-orange">Envie d'aventure ?</h1>
                <h3 class="text-marron"><span id="nomSite">A la Carte</span> vous fait explorer le monde culinaire.</h3>
            </div>
            <button class="big-button">
                <a href="./../pages/carte.html">Accéder à La Carte</a>
            </button>
        </div>
    ...
    <div class="bande bloc-orange">
    </div>

    <div id="bloc-presentation" class="bloc bloc-bleu">
        <p class="text-marron corps-basic">
            Vous vous rappelez de toutes ces fois où vous ne saviez pas quoi manger ? Nous voulons vous faire gagner du temps pour tester toujours plus de restaurant. 
        </p>

        <div id="carte">
            <svg width="1046" height="630" viewBox="0 0 1046 630" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20 1H1026C1036.49 1 1045 9.50659 1045 20V610C1045 620.493 1036.49 629 1026 629H20C9.50659 629 1 620.493 1 610V20C1 9.50659 9.50659 1 20 1Z" fill="#424242" stroke="black" stroke-width="2"/>
            </svg>
        </div>
        <button class="big-button">
            <a href="./../pages/carte.html">Partir à l'aventure !</a>
        </button>
    </div>
    ...
    <div id="bloc-rejoindre" class="bloc bloc-beige">
        <div id="ss-bloc-solitaire">
            <h2 class="text-orange">Solitaire ?</h1>
            <div>
                <img src="../images/Alone.svg">
                <div>
                    <section>
                        <p class="text-marron corps-basic">
                            Cherchez votre prochaine aventure gustative grâce à la Carte !
                        </p>
                        <p class="text-marron corps-script">
                            Qui sait ?
                        </p>
                        <p class="text-marron corps-basic">
                            Vous aurez peut-être même envie de la partager...
                        </p>
                    </section>
                    <button class="big-button">
                        <a href="./../pages/carte.html">Rejoindre la Carte</a>
                    </button>
                </div>
            </div>
        </div>

        <div id="ss-bloc-plusieurs">
            <h2 class="text-orange">Entre amis ?</h1>
            <div>
                <img src="../images/Many.svg">
                <div>
                    <section>
                        <p class="text-marron corps-basic">
                            Cherchez votre prochaine sortie tous en ensemble avec la Carte !                    
                        </p>
                        <p class="text-marron corps-script">
                            Le saviez vous ?
                        </p>
                        <p class="text-marron corps-basic">
                            Vous pouvez réunir vos amis directement depuis A la Carte.                    
                        </p>
                    </section>
                    <button class="big-button">
                        <a href="./../pages/carte.html">Rejoindre la Carte</a>
    ...
    <div id="bloc-decouvertes" class="bloc bloc-vert">

    </div>

    <footer class="bloc-orange">
        <svg id="footer-logo" width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div>
            <div>
                ...
                <svg id="Instagram" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg id="Discord" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg id="Facebook" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
