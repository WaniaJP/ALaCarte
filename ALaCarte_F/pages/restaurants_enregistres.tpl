...
<head>
    ...
    <link rel = "stylesheet" href = "./../style/restaurants_enregistres.css">
    ...
    <title>Restaurants enregistrés</title>
</head>

<body>
    <header class="bloc-orange">
        <div>
        <nav>
            <ul>
            <img src="./../images/White_Logo_H.svg" alt="">
                <li class="text-blanc" ><a href="./../pages/carte.html" class="lien text-blanc">Carte</a></li>
                <li class="text-blanc" ><a href="./../php/restaurants_enregistres.php" class="lien text-blanc">Liste</a></li>
                <li class="text-blanc"><a href="./../php/profil.php" class="lien text-blanc">Profil</a></li>
                <li class="text-blanc"><a href="./../pages/deconnexion.html" class="lien text-blanc">Déconnexion</a></li>
            </ul>
        </nav>
    </div>
    </header>

    <div class="container text-marron">
        <div id="historique">
            <p>
                Votre liste | 
            </p>
        ...
        <p>
            Tous vos restaurants enregistrés au même endroit.
        </p>
        ...
        <div id="etiquettes">
            ...
            $restos = read_restos_bd();
            $nb_restos = count($restos);
            ...
            if($nb_restos != 0) {
                ...
                foreach($restos as $resto) {
                    ...
                    echo('<div class="bloc-blanc cadre">');
                    echo(    '<svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">');
                    echo(        '<circle cx="40" cy="40" r="40" fill="var(--marron)"></circle>');
                    echo(    '</svg>');
                    echo(    '<div class="nom-adresse">');
                    echo(        '<p> <b>' . $nom . '</b> </p>');
                    echo(        '<p>' . $adresse . '</p>');
                    echo(    '</div>');
                    echo(    '<form method = "POST" action = "./../php/restaurant.php?id=' . $id . '&nom=' . $nom . '&adresse=' . $adresse . '"');
                    echo(    '<input type="hidden" name="adresse" value="" />');
                    echo(    '<input class=" kid-button text-marron" type="submit" name="submit" value="Page du restaurant" />');
                    echo(    '</form>');
                    echo('</div>');
                }
            }
